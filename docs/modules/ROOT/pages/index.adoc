...
Currently, this extension is an implementation of the [Docling Serve API](https://docling-project.github.io/docling-java/dev/docling-serve/serve-api/) provided by [Docling Java](https://docling-project.github.io/docling-java) using a [Quarkus REST client](https://quarkus.io/guides/rest-client).
